...
class AccessoriesShop extends StatefulWidget {
  const AccessoriesShop({Key? key}) : super(key: key);

  @override
  State<AccessoriesShop> createState() => _AccessoriesShopState();
}

class _AccessoriesShopState extends State<AccessoriesShop> {
