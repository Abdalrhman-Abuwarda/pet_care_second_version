...
import '../add_pet_model/add_pet_model.dart';
import '../add_pet_model/pet_gender_model.dart';
...
Future<dynamic> pickImage() async {
  ...
  selectPitImage(){
    if (fileImage != null) {
      RouteService.serviceNavi.pushNamedWidget(RouteNames.successAddPatScreen);
      disposeData();
    } else {
